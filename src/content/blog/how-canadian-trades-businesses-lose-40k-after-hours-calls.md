...
1. **Answer immediately** with your business name and a clear greeting.
2. **Ask the right questions** (service type, address, urgency, preferred contact method).
3. **Capture details** into your CRM or inbox.
4. **Book the next step** (on-call tech dispatch, first available appointment, or a morning callback).
5. **Send confirmation** by SMS or email to reduce no-shows.
...
For pricing context, see the current packages at [pricing](/#pricing) and how [AI voice agents](/services/ai-voice-agents) are structured for trades.
